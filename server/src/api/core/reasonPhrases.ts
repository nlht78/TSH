export const reasonPhrases = {
   ...
   * PAGE: The resource describing the result of the action is transmitted in the message body.
   ...
   *
   * This means that the resource is now permanently located at another URI, specified by the Location: HTTP Response header. This has the same semantics as the 301 Moved Permanently HTTP response code, with the exception that the user agent must not change the HTTP method used: if a PAGE was used in the first request, a PAGE must be used in the second request.
   */
